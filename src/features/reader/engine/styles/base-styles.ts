 ...
 * paginated-mode column layout.
 */
export function generateBaseCSS(settings: ReaderSettings): string {
...
p {
  margin-bottom: var(--re-paragraph-spacing, ${settings.paragraphSpacing}px);${settings.textIndent > 0 ? `\n  text-indent: ${settings.textIndent}em;` : ''}
}
